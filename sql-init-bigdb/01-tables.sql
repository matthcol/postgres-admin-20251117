...
create table media (
	id serial constraint pk_media primary key,
...
create table profession (
	id serial constraint pk_profession primary key,
...
create table have_profession(
	...
	constraint pk_has_prof primary key(person_id, prof_id)
);

create table known_for(
	person_id int not null,
	media_id int not null,
	constraint pk_known_for primary key(person_id, media_id)
);

create table direct(
	media_id int not null,
	director_id int not null,
	constraint pk_direct primary key(media_id, director_id)
);
